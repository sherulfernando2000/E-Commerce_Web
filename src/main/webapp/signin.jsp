...
<!-- SignIN 9 - Bootstrap Brain Component -->
            ...
            <div class="col-12 col-md-6 col-xl-7">
                <div class="d-flex justify-content-center text-bg-primary">
                    <div class="col-12 col-xl-9">
                        ...
                        <p class="lead mb-5 text-light">We write words, take photos, make videos, and interact with artificial intelligence.</p>
                        <div class="text-endx">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center">
                                <p class="m-0 text-secondary text-center">Don't have an account?<a href="registration-save.jsp" class="link-primary text-decoration-none">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex gap-2 gap-sm-3 justify-content-center mb-3">
